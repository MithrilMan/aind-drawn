...
export function createVehicleIdentity(
  ...
  const cabinStartRatio = cabin.float(...profile.cabinStartRatio);
  const cabinEndRatio = cabin.float(...profile.cabinEndRatio);
  ...
  return Object.freeze({
    ...
    doors: Object.freeze({
      ...
      hinge: 'front',
      windowFrame: archetype === 'coupe' ? 'frameless' : 'framed',
